...
public class SimpleConsoleRepositoryListener extends AbstractRepositoryListener {

	private static Logger log = LoggerFactory.getLogger(SimpleConsoleRepositoryListener.class);
